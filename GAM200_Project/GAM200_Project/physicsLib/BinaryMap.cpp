...
TileMapCollision::TileMapCollision(GameObjectComposition *owner, objFactory::TileMapData &tilemap) :
GameComponenet(Component_Type::CT_TileMapCollider, owner), pos_(owner->GetTransform()->GetPosition()), tilemap_(tilemap),
